...
class AtmCardRequestPage extends StatefulWidget {
  ...
  static void navigateTo(BuildContext context, Account account) {
    Navigator.of(context).push(MaterialPageRoute(
      builder: (_) => AtmCardRequestPage(account)
    ));
  }
  ...
  _submitRequest() async {
    ...
    if (response.code == 200) {
      await MessageDialog.show(
        context,
        'Your ATM Card request was successfully sent',
        'Request Sent'
      );
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        // ),
                        // SizedBox(height: 8),
                        Text('Select the account below for which you want to request an ATM card')
                      ],
                    )
                  ),
                  Divider(height: 1),
